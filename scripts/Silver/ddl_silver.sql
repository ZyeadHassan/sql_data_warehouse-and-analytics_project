/********************************************************************************************
    Project : Data Warehouse - Silver Layer (Cleansed / Standardized Data)
    Layer   : Silver
    Purpose : To store cleansed and standardized data from the Bronze layer, 
              including ETL audit columns such as dwh_create_date.
********************************************************************************************/
...
CREATE TABLE Silver.crm_cust_info(
    ...
    dwh_create_date     DATETIME2 DEFAULT GETDATE()  -- ETL audit column
);
GO
